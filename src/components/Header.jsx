...
const Header = () => {
    return (
        ...
        <div className="hero-content flex flex-col md:flex-row-reverse">
          <img src={courierImg} className="w-[570px] h-[478px] rounded-lg shadow-2xl flex-1 transform scale-x-[-1]" />
    ...
    <div className="flex md: flex-row">
      ...
      <button type="button" className="text-white bg-[#FF5331] hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 ">Order Now</button>
    </div>
    <div className="flex flex-col md:flex-row">
  <div className="flex-1 p-2">
    <img src={AppleImg} alt="First Image" className="w-[186px] h-[60px]" />
  </div>
  <div className="flex-1 p-2">
    <img src={GoogleImg} alt="Second Image" className="w-[186px] h-[60px]" />
  </div>
</div>
          </div>
        </div>
